...
<form id="simples-form" method="POST" action="./forms/simples_form.php">
    ...
    <input type="<?= $typeControl; ?>" name="subtotal_geral" id="subtotal_geral" value="<?= formatMoedaBr(formatCurrency($pedido->vtotal)) ?>">
    <input type="<?= $typeControl; ?>" name="total_geral" id="total_geral" value="<?= formatMoedaBr(formatCurrency($pedido->vtotal)) ?>">
