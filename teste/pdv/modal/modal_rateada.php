    ...
    <div class="mt-3">
        ...
        <div class="value-container d-flex container-rachadinha">
            ...
            <div class="container-box-items">
                ...
                <input style="width:100%;" type="text" name="quantidade[]" class="rachadinha-value dinheiro" value="<?php echo formatMoedaBr(formatCurrency($pedido->vtotal)) ?>">
...
<script>
    ...
    const valorTotalInicialFormatado = "<?php echo formatMoedaBr(formatCurrency($pedido->vtotal)) ?>";
