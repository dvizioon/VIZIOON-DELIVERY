...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $celular = isset($_POST['celular']) ? sanitize_input($_POST['celular'], $conexao) : 'numero não informado';
        ...
        if ($stmt = $conexao->prepare($query)) {
            ...
            if ($stmt = $conexao->prepare($sql)) {
                ...
                if ($stmt->execute()) {
                    ...
                    //Criar um cupom caso ele esteja Ativo ou Exista;
                    $adcionarCupomCliente = addCumpoCliente($connect, $configuracoesCupom, "criar", [$idu_empresa, $id_pedido, $nome_cliente, $date, $celular, $status_pedido]);
