<form id="parcial-form" method="POST" action="./forms/parcial_form.php">
    ...
    $valorTotalPedidoDescontadoParcial = isset($pedido->descontos) && $pedido->descontos !== "0" ? $pedido->descontos : $pedido->vtotal;
    $valorTotal = isset($pedido->desconto_opcional) && $pedido->desconto_opcional !== "0" ? $valorTotalPedidoDescontadoParcial - $pedido->desconto_opcional : $valorTotalPedidoDescontado;
    $typeControl = "hidden";
    ?>
    ...
    <?php } else { ?>
        <!-- <input type="Text" name="total_geral" value="<?= formatMoedaBr(formatCurrency($valorTotal)) ?>"> -->
    <?php } ?>
    ...
    <div class="mt-3">
        ...
        <div class="value-container d-flex container-parcial">
            ...
            <div class="container-box-items">
                ...
                <input style="width:100%;" type="text" name="quantidade[]" class="parcial-value dinheiro" value="<?php echo !empty($valor_total_faltando) ? formatMoedaBr(formatCurrency($valor_total_faltando)) : formatMoedaBr(formatCurrency($valorTotal)); ?>">
...
<script>
    ...
    const valorTotalInicialParcialFormatado = "<?php echo !empty($valor_total_faltando) ? formatMoedaBr(formatCurrency($valor_total_faltando)) : formatMoedaBr(formatCurrency($valorTotal)); ?>";
