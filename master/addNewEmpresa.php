...
if (isset($_POST["addEmpresa_urln"])) {
    $urln       = $_POST['addEmpresa_urln'];
    $urlm       = $_POST['addEmpresa_urlm'];
    $modelon    = $_POST['addEmpresa_modelon'];
    $nome      = $_POST['addEmpresa_nome'];

    if (empty($_POST['addEmpresa_cpf'])) {
    ...
    $cpf = preg_replace("/[^0-9]/", "", $_POST['addEmpresa_cpf']);
    ...
    if (
        $cpf == '00000000000' || $cpf == '11111111111' || $cpf == '22222222222' || $cpf == '33333333333' || $cpf == '44444444444' || $cpf == '55555555555' || $cpf == '66666666666' ||
        ...
        $celular   = $_POST['addEmpresa_celular'];
        $celular1   = str_replace("(", "", $celular);
        $celular2   = str_replace(")", "", $celular1);
        $celular   = str_replace("-", "", $celular2);

        $senhax    = $_POST['addEmpresa_senha'];
        $senha     = sha1($_POST['addEmpresa_senha']);
        $empresa   = $_POST['addEmpresa_empresa'];
        $email     = $_POST['addEmpresa_email'];
